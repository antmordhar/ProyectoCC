...
public class cocinaControllerTest {
    ...
    public void testConetions() throws Exception {
        ...
        this.restTemplate.postForObject("http://localhost:" + port + "/cocina/post",request,
            String.class);

        assertThat("Inserta el plato por HTTP",this.restTemplate.getForObject("http://localhost:" + port + "/cocina/get/69",String.class)
        ,is(not("[]")));
        ...
        this.restTemplate.delete("http://localhost:" + port + "/cocina/delete/69");
        
        assertThat("Borra el pedido por HTTP",this.restTemplate.getForObject("http://localhost:" + port + "/cocina/get/69",String.class)
        ,is("[]"));
